...
/*
2. Write a 'for' loop that loops through the array ' ["London", "New York", "Paris", "Berlin"]' and skips
'"Paris"'. Store the other cities in a new array named 'visitedCities'.
*/
...
let popularCities = ["Berlin", "Tokyo", "Sydney", "Paris"];
let traveledCities = [];
...
*/
let oldNumbers =[2, 5, 7, 9];
let doubledNumbers =[];

for(i = 0; i < oldNumbers.length; i++){
    if(oldNumbers[i] === 7) continue ;
    doubledNumbers.push(2 * oldNumbers[i]);
}
console.log(doubledNumbers);

/*
10. Use a 'for-of'
'for-of' loop to iterate through the array ["chai", "green tea", "black tea", "jasmine tea", "herbal tea"]'
